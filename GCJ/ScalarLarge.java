...

{
    ...
    {
       fin=new FileReader("A-large-practice(1).IN");
       fout=new PrintWriter("RESULT-large(1).TXT");
    ...
    public void printOutput(long r,int c)throws IOException
     {     
